...
@zedub.zed_cmd(pattern=r"سبونج بوب")
async def kek(kek):
    await kek.edit(M)
...
@zedub.zed_cmd(pattern=r"ثعلب")
async def fox(fox):
    await fox.edit(F)


@zedub.zed_cmd(pattern=r"فيل")
async def elephant(elephant):
    await elephant.edit(E)


@zedub.zed_cmd(pattern=r"معصب")
...
@zedub.zed_cmd(pattern="تسليه10")
async def cmd(zelzallll):
    await edit_or_reply(zelzallll, Fun10_cmd)
