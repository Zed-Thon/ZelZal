...
def main_menu():
    text = f"**🖥┊لـوحـة اوامـر 𝗭𝗧𝗵𝗼𝗻 الشفافـه**\
        \n**🧑🏻‍💻┊المستخـدم ↶** {mention}"
    if Config.OLDZED:
        buttons = [
            ...
            (
                Button.inline(
                    f"الادمن 🧑🏻‍💻 ({len(GRP_INFO['الادمن'])})", data="admin_menu"
                ),
                Button.inline(f"البوت 🦾 ({len(GRP_INFO['البوت'])})", data="bot_menu"),
            ),
            (
                Button.inline(f"الترفيه 🎮 ({len(GRP_INFO['الترفيه'])})", data="fun_menu"),
                Button.inline(f"الخدمات 🧩 ({len(GRP_INFO['الخدمات'])})", data="misc_menu"),
            ),
            (
                Button.inline(f"الادوات 💡 ({len(GRP_INFO['الادوات'])})", data="tools_menu"),
                Button.inline(f"العروض 🖥 ({len(GRP_INFO['العروض'])})", data="utils_menu"),
            ),
            (
                Button.inline(f"البحث 🪄 ({len(GRP_INFO['البحث'])})", data="extra_menu"),
                Button.inline(
                    f"آخرى 🖨 ({len(GRP_INFO['آخرى'])})", data="useless_menu"
                ),
            ),
        ...
        buttons = [
            ...
            (
                Button.inline(f"الترفيه 🎮 ({len(GRP_INFO['الترفيه'])})", data="fun_menu"),
                Button.inline(f"الخدمات 🧩 ({len(GRP_INFO['misc'])})", data="misc_menu"),
            ),
            (
                Button.inline(f"الادوات 💡 ({len(GRP_INFO['الادوات'])})", data="tools_menu"),
                Button.inline(f"العروض 🖥 ({len(GRP_INFO['العروض'])})", data="utils_menu"),
