    ...
    try:
        if BOTLOG:
            Config.ZEDUBLOGO = await zedub.tgbot.send_file(
                ...
                caption="**•⎆┊تـم بـدء تشغـيل سـورس ڤي֠ــ‌ۢـ‌ٰـن֠ــ‌ۢـ‌ٰـﯛ‌م الخاص بك .. بنجاح 🧸♥️**",
                buttons=[(Button.url("𝖛𝖊𝖓𝖔𝖒𓅛", "https://t.me/pp_g3"),)],
            )
    except Exception as e:
        LOGS.error(e)
        return None
...
async def mybot():
    ...
    if bot_name.endswith("Assistant"):
        ...
        try:
            ...
            await bot.send_message("@BotFather", botname)
            await asyncio.sleep(1)
            await bot.send_message("@BotFather", f"- بـوت ڤي֠ــ‌ۢـ‌ٰـن֠ــ‌ۢـ‌ٰـﯛ‌م المسـاعـد ♥️🦾 الخـاص بـ  {bot.me.first_name} ")
            await asyncio.sleep(3)
