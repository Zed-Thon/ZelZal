    ...
    try:
        if BOTLOG:
            Config.ZEDUBLOGO = await zedub.tgbot.send_file(
                BOTLOG_CHATID,
                "https://graph.org/file/39b8f3d6d314ce0fafd54.mp4",
                caption="**•⎆┊تـم بـدء تشغـيل سـورس روزا الخاص بك .. بنجاح 🧸♥️**",
                buttons=[(Button.url("𖣳𝒔𝒐𝒖𝒓𝒄𝒆 𝒓𝒐𝒛𝒂𖣳", "https://t.me/SOURCEROZA"),)],
            )
    except Exception as e:
        LOGS.error(e)
        return None
...
async def verifyLoggerGroup():
    ...
    if BOTLOG:
        ...
        _, groupid = await create_supergroup(
            "اشعارات روزا", zedub, Config.TG_BOT_USERNAME, descript, photozed
        )
    ...
    if PM_LOGGER_GROUP_ID != -100:
        ...
        _, groupid = await create_supergroup(
            "تخزين روزا", zedub, Config.TG_BOT_USERNAME, descript, photozed
        )
