...
'''
mm = '''
قم بلأنضمام الى قناة ڤيجا @devpokemon
'''
...
keyboard = [
  ...
  [
    Button.url("سورس ڤيجا 🤡", "https://t.me/devpokemon")
    ]
]
...
async def users(event):
  async with bot.conversation(event.chat_id) as x:
      ...
      await event.reply(i + "\n\nشكرا لأستخدامك سورس ڤيجا", buttons=keyboard)
...
async def users(event):
  async with bot.conversation(event.chat_id) as x:
      ...
      await event.reply("لقد تم حذف القناة/الكروب شكرا لأستخدامك ڤيجا.", buttons=keyboard)
...
async def users(event):
  async with bot.conversation(event.chat_id) as x:
      ...
      await event.reply("لقد تم انهاء جميع الجلسات شكراً لأستخدامك ڤيجا.", buttons=keyboard)
