...
'''
mm = '''
قم بلأنضمام الى قناة فيجا @devpokemon
'''
...
keyboard = [
  ...
  [
    Button.url("سورس فيجا مطور🤡", "https://t.me/devpokemon")
    ]
]
...
async def users(event):
  async with bot.conversation(event.chat_id) as x:
      ...
      await event.reply(i + "\n\nشكرا لأستخدامك سورس فيجا", buttons=keyboard)
...
async def users(event):
  async with bot.conversation(event.chat_id) as x:
      ...
      await event.reply("لقد تم حذف القناة/الكروب شكرا لأستخدامك فيجا.", buttons=keyboard)
...
async def users(event):
  async with bot.conversation(event.chat_id) as x:
      ...
      await event.reply("لقد تم انهاء جميع الجلسات شكراً لأستخدامك فيجا.", buttons=keyboard)
...
async def start(event):
    keyboard = [
      ...
      [
        Button.url("القناة", "https://t.me/devpokemon")
        ]
    ]
