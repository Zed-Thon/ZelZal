...
Bot_Username = Config.TG_BOT_USERNAME or "missrose_bot"
  ...
  if event.sender_id == bot.uid:
      async with bot.conversation(event.chat_id) as x:
        keyboard = [
          ...
          [
            Button.url("مطـور ااسـورس", "https://t.me/zzzzl1l")
            ]
        ]
        await x.send_message(f"**- مرحبـاً بـك عـزيـزي\n- اليـك قائمـة اوامـر الاختـراق\n- اختر احـد الاوامـر للبـدء** \n\n{menu}", buttons=keyboard)
