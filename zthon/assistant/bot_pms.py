    ...
    if chat.id != Config.OWNER_ID:
        ...
        if customstrmsg is not None:
            ...
            start_msg = f"**❈╎مـرحباً بـك عزيـزي  {mention} **\
                        ...
                        \n\n**❈╎البـوت خـاص بسـورس :** [𓆪𝖘𝖔𝖚𝖗𝖈𝖊 𝖛𝖊𝖌𝖆𓆪𓅛](https://t.me/SOURCEVEGA)"
        buttons = [
            (
                Button.url("قنـاة السـورس", "https://t.me/SOURCEVEGA"),
                Button.url(
                    "مطـور السـورس",
