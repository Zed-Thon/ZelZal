...
from zedub import Config, zedub
...
async def bot_start(event):
    ...
    if chat.id != Config.OWNER_ID:
        ...
        if customstrmsg is not None:
            ...
            start_msg = "**╔━━━━━𓆩• ٖ𝐕ٰٖ𝐄ٰٰٖٖٖ𝐆ٰٖ𝐀ٰٖٖ⚡️•𓆪━━━━━━╗ \n🎤╖ أهلآ بك عزيزي أنا بوت » ڤيجا\n⚙️╢ وظيفتي حماية المجموعات\n✅╢ لتفعيل البوت عليك اتباع مايلي\n🔘╢ أضف البوت إلى مجموعتك\n⚡️╜ أرفعه » مشرف\n╚━━━━━𓆩• ٖ𝐕ٰٖ𝐄ٰٰٖٖٖ𝐆ٰٖ𝐀ٰٖٖ⚡️•𓆪━━━━━━╝**"
        buttons = [
            [
                Button.url("•▶️ السورس ◀️•", "t.me/SOURCEVEGA"),
                Button.inline("•🔽 الاوامر 🔼 •", data="CMDBOT"),
            ],
            [
                Button.inline("•❌ اوامر البوت ❌•", data="setting"),
                Button.inline("•♈ المبرمج زين ♈•", data="t.me/devpokemon"),
            ],
        ]
    else:
        start_msg = "**╔━━━━━𓆩• ٖ𝐕ٰٖ𝐄ٰٰٖٖٖ𝐆ٰٖ𝐀ٰٖٖ⚡️•𓆪━━━━━━╗ \n🎤╖ أهلآ بك عزيزي أنا بوت » ڤيجا\n⚙️╢ وظيفتي حماية المجموعات\n✅╢ لتفعيل البوت عليك اتباع مايلي\n🔘╢ أضف البوت إلى مجموعتك\n⚡️╜ أرفعه » مشرف\n╚━━━━━𓆩• ٖ𝐕ٰٖ𝐄ٰٰٖٖٖ𝐆ٰٖ𝐀ٰٖٖ⚡️•𓆪━━━━━━╝**"
...
الامر:             `.اضف الرمز`
الشرح :  يقوم هذا الامر باضف رمز بداية اسم حسابك عند تشغيل امر  .اسم وقتي
الاستخدام : تقوم بالرد على الرمز بالامر   `.اضف الرمز`


ملاحظة : يمكنك استخدام الاوامر في اي دردشة او محادثة
اوامر فارات سورس فيجا  @SOURCEVEGA""",
        buttons=[
...
الامر:             `.اضف الصورة`
الشرح :  يقوم هذا الامر باضف الصورة الخاصة بحسابك عند تشغيل امر الصورة الوقتية
...
الامر:             `.اضف البايو`
الشرح :  يقوم هذا الامر باضف النبذه او البايو عند تشغيل امر البايو الوقتي
...
**ملاحظة: يجب اني تقوم باضف الزخرفة بالترتيب التالي:**
0123456789
ملاحظة : يمكنك استخدام الاوامر في اي دردشة او محادثة
اوامر فارات سورس فيجا @SOURCEVEGA""",
        buttons=[
...
الامر:             `.اضف الاسم`
الشرح :  يقوم هذا الامر باضف اسم حسابك للعديد من الاوامر مثل الفحص والخ
...
الاستخدام : تقوم بالرد على الكليشة التي تريد اضفها بالامر   `.اضف كليشة الحظر `
...
الاستخدام : تقوم بالرد على الكليشة التي تريد اضفها بالامر   `.اضف كليشة الحماية `

* يمكنك الحصول على  كليشة جاهزة من هذه القناة @SOURCEVEGA 
...
الاستخدام : تقوم بالرد على رابط الصورة التي تريد اضفها بالامر   `.اضف صورة الحماية` 
...
الاستخدام : تقوم بالرد على رابط الصورة التي تريد اضفها بالامر   `.اضف صورة الفحص` 
...
الاستخدام : تقوم بالرد على الكليشة التي تريد اضفها بالامر   `.اضف كليشة الفحص `
...
الاستخدام : تقوم بالرد على الرمز التي تريد اضفه بالامر   `.اضف رمز الفحص `
