...
ZED_FONT = Config.DEFAULT_PIC or "zthon/helpers/styles/rasool.ttf"
zedfont = Config.DEFAULT_PIC or "zthon/helpers/styles/rasool.ttf"
...
async def digitalpicloop():
    ...
    while DIGITALPICSTART:
        ...
        fnt = ImageFont.truetype(zedfont, 55)
        drawn_text.text((300, 200), current_time, font=fnt, fill=(280, 280, 280))
