...
if Config.TG_BOT_USERNAME is not None and tgbot is not None:
    ...
    async def inline_handler(event):
        ...
        if query.startswith("مساعده") and event.query.user_id == zedub.uid:
            buttons = [
                [Button.inline("𝖈𝖗 𝖘𝖔𝖚𝖗𝖈𝖊", data="MMM")],
                [
...
async def _(event):
    await event.edit(
        "[ᯓ 𝖈𝖗 𝖘𝖔𝖚𝖗𝖈𝖊 - اوامــر المجمــوعــه 🛗](t.me/S_EG_P) .\n\n**⎉╎اليك عـزيـزي شـࢪوحـات اوامـر المجمــوعــه :**\n\n",
        buttons=[
            [
...
async def _(event):
    await event.edit(
        """[ᯓ 𝖈𝖗 𝖘𝖔𝖚𝖗𝖈𝖊 - اوامــر مكـافح التكــرار 🛡](t.me/S_EG_P) .
**- الامـر :**
**⪼** `.ضع التكرار`
...
async def _(event):
    await event.edit(
        """[ᯓ 𝖈𝖗 𝖘𝖔𝖚𝖗𝖈𝖊 - اوامــر المنــع 🚫](t.me/S_EG_P) .
**- الامـر :**
**⪼** `.منع`
**⪼** `.الغاء منع`
**⪼** `.قائمة المنع`
...
async def _(event):
    await event.edit(
        "[ᯓ 𝖈𝖗 𝖘𝖔𝖚𝖗𝖈𝖊 - اوامــر الاضـافه والتفليـش 👾](t.me/S_EG_P) .\n\n**⎉╎اليك عـزيـزي شـࢪوحـات اوامـر الاضـافه والتفليـش :**\n\n",
        buttons=[
            [
...
async def _(event):
    await event.edit(
        "[ᯓ 𝖈𝖗 𝖘𝖔𝖚𝖗𝖈𝖊 - اوامــر الفــارات 🧬](t.me/S_EG_P) .\n\n**⎉╎اليك عـزيـزي شـࢪوحـات اوامـر الفــارات :**\n\n",
        buttons=[
            [
...
async def _(event):
    await event.edit(
        "[ᯓ 𝖈𝖗 𝖘𝖔𝖚𝖗𝖈𝖊 - اوامــر فــارات الوقتــي 🕰](t.me/S_EG_P) .\n\n**⎉╎اليك عـزيـزي شـࢪوحـات اوامـر فــارات الوقتــي :**\n\n",
        buttons=[
            [
...
async def _(event):
    await event.edit(
        "[ᯓ 𝖈𝖗 𝖘𝖔𝖚𝖗𝖈𝖊 - اوامــر فــارات المنطقـه الزمنيـة 🌐](t.me/S_EG_P) .\n\n**⎉╎اليك عـزيـزي شـࢪوحـات اوامـر فــارات المنطقـه الزمنيـة :**\n\n",
        buttons=[
...
async def _(event):
    await event.edit(
        "[ᯓ 𝖈𝖗 𝖘𝖔𝖚𝖗𝖈𝖊 - اوامــر فــارات حمايـة الخــاص 🛄](t.me/S_EG_P) .\n\n**⎉╎اليك عـزيـزي شـࢪوحـات اوامـر فــارات حمايـة الخــاص :**\n\n",
        buttons=[
            [
...
async def _(event):
    await event.edit(
        "[ᯓ 𝖈𝖗 𝖘𝖔𝖚𝖗𝖈𝖊 - اوامــر فــارات الفحـص 🏮](t.me/S_EG_P) .\n\n**⎉╎اليك عـزيـزي شـࢪوحـات اوامـر فــارات الفحـص :**\n\n",
        buttons=[
            [
...
async def _(event):
    await event.edit(
        """[ᯓ 𝗭??𝗵𝗼𝗻 𝗨𝘀𝗲𝗿𝗯𝗼𝘁 - اوامــر البحـث والتحميــل 🛰](t.me/S_EG_P) .
**- الامـر :**
**⪼** `.بحث`
**⪼** `.اغنيه`
...
async def _(event):
    await event.edit(
        "[ᯓ 𝖈𝖗 𝖘𝖔𝖚𝖗𝖈𝖊 - اوامــر التسليـه والتحشيش 🏂🎃](t.me/S_EG_P) .\n\n**⎉╎اليك عـزيـزي شـࢪوحـات اوامـر التسليـه والتحشيش :**\n\n",
        buttons=[
            [
...
async def _(event):
    await event.edit(
        """[ᯓ 𝖈𝖗 𝖘𝖔𝖚𝖗𝖈𝖊 - اوامــر التسليـه 🏂](t.me/S_EG_P) .
**⪼** `.تسليه1`
**⪼** `.تسليه2`
**⪼** `.تسليه3`
**⪼** `.تسليه4`
...
async def _(event):
    await event.edit(
        """[ᯓ 𝖈𝖗 𝖘𝖔𝖚𝖗𝖈𝖊 - اوامــر التحشيش 🎃](t.me/S_EG_P) .
**- الامـر :**
**⪼** `.رفع تاج`
**⪼** `.رفع بقلبي`
**⪼** `.رفع مرتي`
...
async def _(event):
    await event.edit(
        """[ᯓ 𝖈𝖗 𝖘𝖔𝖚𝖗𝖈𝖊 - اوامــر الالـعــاب 🎮🎳](t.me/S_EG_P) .
**- الامـر :**
**⪼** `.بلاي`
...
async def _(event):
    await event.edit(
        """[ᯓ 𝖈𝖗 𝖘𝖔𝖚𝖗𝖈𝖊 - اوامــر حمـايــة الخــاص 🛡](t.me/S_EG_P) .
**⪼** `.الحمايه تفعيل`
...
async def _(event):
    await event.edit(
        """[ᯓ 𝖈𝖗 𝖘𝖔𝖚𝖗𝖈𝖊 - فــارات حمـايــة الخــاص 🛡](t.me/S_EG_P) .
**⪼** `.اضف عدد التحذيرات`
**لـ تغييـر عدد تحذيرات امـر حماية الخاص التي يقوم البوت باعطائها للشخص الذي يراسلك خاص قبل حظـره**
...
async def _(event):
    await event.edit(
        """[ᯓ 𝗭𝗧𝗵𝗼𝗻 𝗨𝘀𝗲𝗿??𝗼𝘁 - اوامــر الحســاب 🚹](t.me/S_EG_P) .
**- الامـر :**
**⪼** `.ايدي`
**⪼** `.ا`
**⪼** `.ايديي`
...
async def _(event):
    await event.edit(
        """[ᯓ 𝖈𝖗 𝖘𝖔𝖚𝖗𝖈𝖊 - اوامــر الستـوريـات 🎆🏖](t.me/S_EG_P) .
**- الامـر :**
**⪼** `.حالات واتس`
...
async def _(event):
    await event.edit(
        """[ᯓ 𝖈𝖗 𝖘𝖔𝖚𝖗𝖈𝖊 - اوامــر الآفتـــارات والصــور 🎆🏖](t.me/S_EG_P) .
**- الامـر :**
**⪼** `.بنات`
...
async def _(event):
    await event.edit(
        """[ᯓ 𝖈𝖗 𝖘𝖔𝖚𝖗𝖈𝖊 - اوامــر الاشتــراك الاجبــاري 🛗](t.me/S_EG_P) .
**- الامـر :**
...
async def _(event):
    await event.edit(
        """[ᯓ 𝖈𝖗 𝖘𝖔𝖚𝖗𝖈𝖊 - اوامــر الصيـد & التشيكـر ❇️](t.me/S_EG_P) .
...
async def zed_help(event):
    await event.edit(
        "[ᯓ 𝖈𝖗 𝖘𝖔𝖚𝖗𝖈𝖊 - اوامــر تجميـع النقـاط 💡](t.me/S_EG_P) .\n\n**⎉╎اليك عـزيـزي شـࢪوحـات اوامـر تجميـع النقـاط :**\n\n",
        buttons=[
            [
...
async def _(event):
    await event.edit(
        """[ᯓ 𝖈𝖗 𝖘𝖔𝖚𝖗𝖈𝖊 - اوامــر تجميــع النقــاط 🛂](t.me/S_EG_P) .
**- الامـر :**
**⪼** `.المليار`
...
async def _(event):
    await event.edit(
        """[ᯓ 𝖈𝖗 𝖘𝖔𝖚𝖗𝖈𝖊 - اوامــر النشــر التلقــائي 🌐](t.me/S_EG_P) .
**- الامـر :**
**⪼** `.تلقائي`
