...
if Config.TG_BOT_USERNAME is not None and tgbot is not None:
    ...
    async def inline_handler(event):
        ...
        if query.startswith("مساعده") and event.query.user_id == zedub.uid:
            buttons = [
                [Button.inline("𖤐𝖛𝖊𝖓𝖔𝖒𖤐", data="MMM")],
                [
...
async def _(event):
    await event.edit(
        "[ᯓ 𖤐𝖛𝖊𝖓𝖔𝖒𖤐 - اوامــر المجمــوعــه 🛗](t.me/q_k_2) .\n\n**⎉╎اليك عـزيـزي شـࢪوحـات اوامـر المجمــوعــه :**\n\n",
        buttons=[
            [
...
async def _(event):
    await event.edit(
        """[ᯓ 𖤐𝖛𝖊𝖓𝖔𝖒𖤐 - اوامــر مكـافح التكــرار 🛡](t.me/q_k_2) .
**- الامـر :**
**⪼** `.ضع التكرار`
...
async def _(event):
    await event.edit(
        """[ᯓ 𖤐𝖛𝖊𝖓𝖔𝖒𖤐 - اوامــر المنــع 🚫](t.me/q_k_2) .
**- الامـر :**
**⪼** `.منع`
**⪼** `.الغاء منع`
**⪼** `.قائمة المنع`
...
async def _(event):
    await event.edit(
        "[ᯓ 𖤐𝖛𝖊𝖓𝖔𝖒𖤐 - اوامــر الاضـافه والتفليـش 👾](t.me/q_k_2) .\n\n**⎉╎اليك عـزيـزي شـࢪوحـات اوامـر الاضـافه والتفليـش :**\n\n",
        buttons=[
            [
...
async def _(event):
    await event.edit(
        "[ᯓ 𖤐𝖛𝖊𝖓𝖔𝖒𖤐 - اوامــر الفــارات 🧬](t.me/q_k_2) .\n\n**⎉╎اليك عـزيـزي شـࢪوحـات اوامـر الفــارات :**\n\n",
        buttons=[
            [
...
async def _(event):
    await event.edit(
        "[ᯓ 𖤐𝖛𝖊𝖓𝖔𝖒𖤐 - اوامــر فــارات الوقتــي 🕰](t.me/q_k_2) .\n\n**⎉╎اليك عـزيـزي شـࢪوحـات اوامـر فــارات الوقتــي :**\n\n",
        buttons=[
            [
...
async def _(event):
    await event.edit(
        "[ᯓ 𖤐𝖛𝖊𝖓𝖔𝖒𖤐 - اوامــر فــارات المنطقـه الزمنيـة 🌐](t.me/q_k_2) .\n\n**⎉╎اليك عـزيـزي شـࢪوحـات اوامـر فــارات المنطقـه الزمنيـة :**\n\n",
        buttons=[
...
async def _(event):
    await event.edit(
        "[ᯓ 𖤐𝖛𝖊𝖓𝖔𝖒𖤐 - اوامــر فــارات حمايـة الخــاص 🛄](t.me/q_k_2) .\n\n**⎉╎اليك عـزيـزي شـࢪوحـات اوامـر فــارات حمايـة الخــاص :**\n\n",
        buttons=[
            [
...
async def _(event):
    await event.edit(
        "[ᯓ 𖤐𝖛𝖊𝖓𝖔𝖒𖤐 - اوامــر فــارات الفحـص 🏮](t.me/q_k_2) .\n\n**⎉╎اليك عـزيـزي شـࢪوحـات اوامـر فــارات الفحـص :**\n\n",
        buttons=[
            [
...
async def _(event):
    await event.edit(
        """[ᯓ 𝗭??𝗵𝗼𝗻 𝗨𝘀𝗲𝗿𝗯𝗼𝘁 - اوامــر البحـث والتحميــل 🛰](t.me/q_k_2) .
**- الامـر :**
**⪼** `.بحث`
**⪼** `.اغنيه`
...
async def _(event):
    await event.edit(
        "[ᯓ 𖤐𝖛𝖊𝖓𝖔𝖒𖤐 - اوامــر التسليـه والتحشيش 🏂🎃](t.me/q_k_2) .\n\n**⎉╎اليك عـزيـزي شـࢪوحـات اوامـر التسليـه والتحشيش :**\n\n",
        buttons=[
            [
...
async def _(event):
    await event.edit(
        """[ᯓ 𖤐𝖛𝖊𝖓𝖔𝖒𖤐 - اوامــر التسليـه 🏂](t.me/q_k_2) .
**⪼** `.تسليه1`
**⪼** `.تسليه2`
**⪼** `.تسليه3`
**⪼** `.تسليه4`
...
async def _(event):
    await event.edit(
        """[ᯓ 𖤐𝖛𝖊𝖓𝖔𝖒𖤐 - اوامــر التحشيش 🎃](t.me/q_k_2) .
**- الامـر :**
**⪼** `.رفع تاج`
**⪼** `.رفع بقلبي`
**⪼** `.رفع مرتي`
...
async def _(event):
    await event.edit(
        """[ᯓ 𖤐𝖛𝖊𝖓𝖔𝖒𖤐 - اوامــر الالـعــاب 🎮🎳](t.me/q_k_2) .
**- الامـر :**
**⪼** `.بلاي`
...
async def _(event):
    await event.edit(
        """[ᯓ 𖤐𝖛𝖊𝖓𝖔𝖒𖤐 - اوامــر حمـايــة الخــاص 🛡](t.me/q_k_2) .
**⪼** `.الحمايه تفعيل`
...
async def _(event):
    await event.edit(
        """[ᯓ 𖤐𝖛𝖊𝖓𝖔𝖒𖤐 - فــارات حمـايــة الخــاص 🛡](t.me/q_k_2) .
**⪼** `.اضف عدد التحذيرات`
**لـ تغييـر عدد تحذيرات امـر حماية الخاص التي يقوم البوت باعطائها للشخص الذي يراسلك خاص قبل حظـره**
...
async def _(event):
    await event.edit(
        """[ᯓ 𝗭𝗧𝗵𝗼𝗻 𝗨𝘀𝗲𝗿??𝗼𝘁 - اوامــر الحســاب 🚹](t.me/q_k_2) .
**- الامـر :**
**⪼** `.ايدي`
**⪼** `.ا`
**⪼** `.ايديي`
...
async def _(event):
    await event.edit(
        """[ᯓ 𖤐𝖛𝖊𝖓𝖔𝖒𖤐 - اوامــر الستـوريـات 🎆🏖](t.me/q_k_2) .
**- الامـر :**
**⪼** `.حالات واتس`
...
async def _(event):
    await event.edit(
        """[ᯓ 𖤐𝖛𝖊𝖓𝖔𝖒𖤐 - اوامــر الآفتـــارات والصــور 🎆🏖](t.me/q_k_2) .
**- الامـر :**
**⪼** `.بنات`
...
async def _(event):
    await event.edit(
        """[ᯓ 𖤐𝖛𝖊𝖓𝖔𝖒𖤐 - اوامــر الاشتــراك الاجبــاري 🛗](t.me/q_k_2) .
**- الامـر :**
...
async def _(event):
    await event.edit(
        """[ᯓ 𖤐𝖛𝖊𝖓𝖔𝖒𖤐 - اوامــر الصيـد & التشيكـر ❇️](t.me/q_k_2) .
...
async def zed_help(event):
    await event.edit(
        "[ᯓ 𖤐𝖛𝖊𝖓𝖔𝖒𖤐 - اوامــر تجميـع النقـاط 💡](t.me/q_k_2) .\n\n**⎉╎اليك عـزيـزي شـࢪوحـات اوامـر تجميـع النقـاط :**\n\n",
        buttons=[
            [
...
async def _(event):
    await event.edit(
        """[ᯓ 𖤐𝖛𝖊𝖓𝖔𝖒𖤐 - اوامــر تجميــع النقــاط 🛂](t.me/q_k_2) .
**- الامـر :**
**⪼** `.المليار`
...
async def _(event):
    await event.edit(
        """[ᯓ 𖤐𝖛𝖊𝖓𝖔𝖒𖤐 - اوامــر النشــر التلقــائي 🌐](t.me/q_k_2) .
**- الامـر :**
**⪼** `.تلقائي`
