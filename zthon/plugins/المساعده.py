...
**- الاستخـدام :**
(`.انشاء كروب`) **: لـ إنشـاء مجمـوعـة جـاهزه**
(`.انشاء قناه`) **: لـ إنشـاء قنـاة جـاهزه**
(`.انشاء خارق`) **: لـ إنشـاء مجمـوعـة خـارقـه**""",
        buttons=[
            [Button.inline("رجوع", data="nexttools")],
        ],
    link_preview=False)
