...
if Config.TG_BOT_USERNAME is not None and tgbot is not None:
    ...
    async def inline_handler(event):
        ...
        if query.startswith("مساعده") and event.query.user_id == zedub.uid:
            buttons = [
                [Button.inline("𝙎𝙊𝙐𝙍𝘾𝞝 ᴧꝛᴛᴇx", data="MMM")],
                [
...
async def _(event):
    await event.edit(
        "[ᯓ 𝙎𝙊𝙐𝙍𝘾𝞝 ᴧꝛᴛᴇx - اوامــر المجمــوعــه 🛗](t.me/pp_g3) .\n\n**⎉╎اليك عـزيـزي شـࢪوحـات اوامـر المجمــوعــه :**\n\n",
        buttons=[
            [
...
async def _(event):
    await event.edit(
        """[ᯓ 𝙎𝙊𝙐𝙍𝘾𝞝 ᴧꝛᴛᴇx - اوامــر مكـافح التكــرار 🛡](t.me/pp_g3) .
**- الامـر :**
**⪼** `.ضع التكرار`
...
async def _(event):
    await event.edit(
        """[ᯓ 𝙎𝙊𝙐𝙍𝘾𝞝 ᴧꝛᴛᴇx - اوامــر المنــع 🚫](t.me/pp_g3) .
**- الامـر :**
**⪼** `.منع`
**⪼** `.الغاء منع`
**⪼** `.قائمة المنع`
...
async def _(event):
    await event.edit(
        "[ᯓ 𝙎𝙊𝙐𝙍𝘾𝞝 ᴧꝛᴛᴇx - اوامــر الاضـافه والتفليـش 👾](t.me/pp_g3) .\n\n**⎉╎اليك عـزيـزي شـࢪوحـات اوامـر الاضـافه والتفليـش :**\n\n",
        buttons=[
            [
...
async def _(event):
    await event.edit(
        "[ᯓ 𝙎𝙊𝙐𝙍𝘾𝞝 ᴧꝛᴛᴇx - اوامــر الفــارات 🧬](t.me/pp_g3) .\n\n**⎉╎اليك عـزيـزي شـࢪوحـات اوامـر الفــارات :**\n\n",
        buttons=[
            [
...
async def _(event):
    await event.edit(
        "[ᯓ 𝙎𝙊𝙐𝙍𝘾𝞝 ᴧꝛᴛᴇx - اوامــر فــارات الوقتــي 🕰](t.me/pp_g3) .\n\n**⎉╎اليك عـزيـزي شـࢪوحـات اوامـر فــارات الوقتــي :**\n\n",
        buttons=[
            [
...
async def _(event):
    await event.edit(
        "[ᯓ 𝙎𝙊𝙐𝙍𝘾𝞝 ᴧꝛᴛᴇx - اوامــر فــارات المنطقـه الزمنيـة 🌐](t.me/pp_g3) .\n\n**⎉╎اليك عـزيـزي شـࢪوحـات اوامـر فــارات المنطقـه الزمنيـة :**\n\n",
        buttons=[
...
async def _(event):
    await event.edit(
        "[ᯓ 𝙎𝙊𝙐𝙍𝘾𝞝 ᴧꝛᴛᴇx - اوامــر فــارات حمايـة الخــاص 🛄](t.me/pp_g3) .\n\n**⎉╎اليك عـزيـزي شـࢪوحـات اوامـر فــارات حمايـة الخــاص :**\n\n",
        buttons=[
            [
...
async def _(event):
    await event.edit(
        "[ᯓ 𝙎𝙊𝙐𝙍𝘾𝞝 ᴧꝛᴛᴇx - اوامــر فــارات الفحـص 🏮](t.me/pp_g3) .\n\n**⎉╎اليك عـزيـزي شـࢪوحـات اوامـر فــارات الفحـص :**\n\n",
        buttons=[
            [
...
async def _(event):
    await event.edit(
        "[ᯓ 𝙎𝙊𝙐𝙍𝘾𝞝 ᴧꝛᴛᴇx - اوامــر التسليـه والتحشيش 🏂🎃](t.me/pp_g3) .\n\n**⎉╎اليك عـزيـزي شـࢪوحـات اوامـر التسليـه والتحشيش :**\n\n",
        buttons=[
            [
...
async def _(event):
    await event.edit(
        """[ᯓ 𝙎𝙊𝙐𝙍𝘾𝞝 ᴧꝛᴛᴇx - اوامــر التسليـه 🏂](t.me/pp_g3) .
**⪼** `.تسليه1`
**⪼** `.تسليه2`
**⪼** `.تسليه3`
**⪼** `.تسليه4`
...
async def _(event):
    await event.edit(
        """[ᯓ 𝙎𝙊𝙐𝙍𝘾𝞝 ᴧꝛᴛᴇx - اوامــر التحشيش 🎃](t.me/pp_g3) .
**- الامـر :**
**⪼** `.رفع تاج`
**⪼** `.رفع بقلبي`
**⪼** `.رفع مرتي`
...
async def _(event):
    await event.edit(
        """[ᯓ 𝙎𝙊𝙐𝙍𝘾𝞝 ᴧꝛᴛᴇx - اوامــر الالـعــاب 🎮🎳](t.me/pp_g3) .
**- الامـر :**
**⪼** `.بلاي`
...
async def _(event):
    await event.edit(
        """[ᯓ 𝙎𝙊𝙐𝙍𝘾𝞝 ᴧꝛᴛᴇx - اوامــر حمـايــة الخــاص 🛡](t.me/pp_g3) .
**⪼** `.الحمايه تفعيل`
...
async def _(event):
    await event.edit(
        """[ᯓ 𝙎𝙊𝙐𝙍𝘾𝞝 ᴧꝛᴛᴇx - فــارات حمـايــة الخــاص 🛡](t.me/pp_g3) .
**⪼** `.اضف عدد التحذيرات`
**لـ تغييـر عدد تحذيرات امـر حماية الخاص التي يقوم البوت باعطائها للشخص الذي يراسلك خاص قبل حظـره**
...
async def zed_help(event):
    await event.edit(
        "[ᯓ 𝙎𝙊𝙐𝙍𝘾𝞝 ᴧꝛᴛᴇx - اوامــر المـرفقــات 🖥](t.me/pp_g3) .\n\n**⎉╎اليك عـزيـزي شـࢪوحـات اوامـر مرفقـات السـورس :**\n\n",
        buttons=[
            [
...
async def _(event):
    await event.edit(
        """[ᯓ 𝙎𝙊𝙐𝙍𝘾𝞝 ᴧꝛᴛᴇx - اوامــر الستـوريـات 🎆🏖](t.me/pp_g3) .
**- الامـر :**
**⪼** `.حالات واتس`
...
async def _(event):
    await event.edit(
        """[ᯓ 𝙎𝙊𝙐𝙍𝘾𝞝 ᴧꝛᴛᴇx - اوامــر الآفتـــارات والصــور 🎆🏖](t.me/pp_g3) .
**- الامـر :**
**⪼** `.بنات`
...
**- مثـال :**
`.اختصار https://github.com/Zeinn0/ZelZal`
...
async def _(event):
    await event.edit(
        """[ᯓ 𝙎𝙊𝙐𝙍𝘾𝞝 ᴧꝛᴛᴇx - اوامــر الاشتــراك الاجبــاري 🛗](t.me/pp_g3) .
**- الامـر :**
...
async def _(event):
    await event.edit(
        """[ᯓ 𝙎𝙊𝙐𝙍𝘾𝞝 ᴧꝛᴛᴇx - اوامــر الصيـد & التشيكـر ❇️](t.me/pp_g3) .
...
async def zed_help(event):
    await event.edit(
        "[ᯓ 𝙎𝙊𝙐𝙍𝘾𝞝 ᴧꝛᴛᴇx - اوامــر تجميـع النقـاط 💡](t.me/pp_g3) .\n\n**⎉╎اليك عـزيـزي شـࢪوحـات اوامـر تجميـع النقـاط :**\n\n",
        buttons=[
            [
...
async def _(event):
    await event.edit(
        """[ᯓ 𝙎𝙊𝙐𝙍𝘾𝞝 ᴧꝛᴛᴇx - اوامــر تجميــع النقــاط 🛂](t.me/pp_g3) .
**- الامـر :**
**⪼** `.المليار`
...
async def _(event):
    await event.edit(
        """[ᯓ 𝙎𝙊𝙐𝙍𝘾𝞝 ᴧꝛᴛᴇx - اوامــر النشــر التلقــائي 🌐](t.me/pp_g3) .
**- الامـر :**
**⪼** `.تلقائي`
