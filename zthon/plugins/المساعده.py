    ...
    async def inline_handler(event):
        ...
        if query.startswith("مساعده") and event.query.user_id == zedub.uid:
            buttons = [
                ...
                [
                    Button.inline("االمرفقـات 🪁", data="extras"),
...
**- الوصـف :**
لـ عـرض اوامـر المطـور المسـاعد من رفع وتنزيل اي شخص معاك بالبوت حتى يستطيع من استخدام الاوامر معك وعـرض اوامر التحكم المعطاه لهـذا الشخص

**- الاستخـدام :**
ارسـل الامـر   `.المساعد`""",
        buttons=[
            [Button.inline("رجوع", data="botvr")],
        ],
    link_preview=False)
...
**- الوصـف :**
(.رسائلي) لـ عـرض عـدد رسـائلك او (.رسائله) لـ عـرض عـدد رسائل شخـص في المجمـوعـة
...
**- الوصـف :**
لـ حـذف جميـع رسـائلك في المجمـوعـة

**- الاستخـدام :**
ارسـل الامـر    `.حذف رسائلي`""",
        buttons=[
            [Button.inline("رجوع", data="group2vr")],
        ],
    link_preview=False)
...
**- الوصـف :**
لـ اضافة وسحب اعضـاء من مجمـوعـة الى مجمـوعـة آخـرى

**- الاستخـدام :**
ارسـل الامـر التالـي في مجمـوعتـك
`.اضافه`   +  رابـط المجمـوعـة المـراد سحب الاعضـاء منهـا
او `.ضيف`   +  رابـط المجمـوعـة المـراد سحب الاعضـاء منهـا""",
        buttons=[
...
**- الوصـف :**
لـ البحث وتحميـل مقاطـع الصـوت والفيديـو والافـلام والمسلسلات مـن اليوتيـوب بعـدة صيـغ عبـر لوحـة انلايـن شفافـه

**- ملاحظـه :**
هذا الامر يدعم تحميل مقاطع صوت وفيديو عالية الدقه تصـل الى 5 جيجابايت وبسرعه تحميـل عاليـه
...
**- الوصـف :**
العـاب سـورس زدثــون ممطـروقـه جربهـن راح يعجبنـك 🥳💞
...
async def _(event):
    await event.edit(
        """[ᯓ 𝗭𝗧𝗵𝗼𝗻 𝗨𝘀𝗲𝗿??𝗼𝘁 - اوامــر الحســاب 🚹](t.me/ZedThon) .
**- الامـر :**
**⪼** `.ايدي`
**⪼** `.ا`
**⪼** `.ايديي`
...
async def zed_help(event):
    await event.edit(
        ...
        buttons=[
            ...
            [
                Button.inline("حفظ الذاتيه", data="thatia"),
            ],
            [
...
**- الوصـف :**
لـ حفظ الصورة او الفيديـو الذاتيـه او المؤقتـه والممنـوع حفظهـا على تيليجـرام

**- الاستخـدام :**
`.ذاتيه`   **بالـرد ع الصـورة**""",
        buttons=[
            [Button.inline("رجوع", data="extras")],
        ],
    link_preview=False)
