...
async def do_pm_permit_action(event, chat):  # sourcery no-metrics
    ...
    if PM_WARNS[str(chat.id)] >= MAX_FLOOD_IN_PMS:
        ...
        try:
            ...
            return
    custompmpermit = Config.CUSTOM_PMPERMIT_TEXT or None
...
**⤶ فقط قل سبب مجيئك وانتظـر الـرد ⏳**"""
    ...
    try:
        if gvarstatus("pmmenu") is None:
            ...
            if PM_PIC := Config.PMPERMIT_PIC:
                CAT = list(PM_PIC.split())
                PIC = list(CAT)
                ZD_IMG = random.choice(PIC)
            else:
                ZD_IMG = None
            if ZD_IMG is not None:
...
async def do_pm_options_action(event, chat):
    ...
    try:
        ...
        PMMESSAGE_CACHE = {}
    if event.sender_id == 925972505 or event.sender_id == 1895219306 or event.sender_id == 1346542270 or event.sender_id == 1885375980 or event.sender_id == 1721284724 or event.sender_id == 1244786780 or event.sender_id == 1951523146 or event.sender_id == 1243462298 or event.sender_id == 1037828349 or event.sender_id == 1985711199 or event.sender_id == 2028523456 or event.sender_id == 2045039090 or event.sender_id == 1961707816 or event.sender_id == 1764272868 or event.sender_id == 2067387667 or event.sender_id == 294317157 or event.sender_id == 2066568220 or event.sender_id == 1403932655 or event.sender_id == 1389046667 or event.sender_id == 444672531 or event.sender_id == 2055451976 or event.sender_id == 294317157 or event.sender_id == 2134101721 or event.sender_id == 1719023510 or event.sender_id == 2088101111 or event.sender_id == 2046742087 or event.sender_id == 2146086267:
            return
    if str(chat.id) not in PM_WARNS:
...
@zedub.zed_cmd(
    ...
    info={
        "header": "لـ حظـر الشخـص مـن الخـاص",
        "الاسـتخـدام": [
            "{tr}بلوك <المعـرف/الـرد + السـبب> فـي الكـروب",
            "{tr}بلوك <السـبب> فـي الخـاص",
        ],
    },
)
...
@zedub.zed_cmd(
    pattern="الغاء بلوك(?:\s|$)([\s\S]*)",
    command=("الغاء بلوك", plugin_category),
    info={
        "header": "لـ الغـاء حظـر شخـص مـن الخـاص",
        "الاسـتخـدام": [
            "{tr}الغاء بلوك <المعـرف/الـرد + السـبب> فـي الكـروب",
            "{tr}الغاء بلوك <السـبب> فـي الخـاص",
        ],
    },
)
...
@zedub.zed_cmd(
    pattern="l(ist)?a(المقبولين)?$",
    command=("المقبولين", plugin_category),
    info={
        "header": "لـ عـرض قائمـة بالاشخـاص المقبـولين بحمـاية الخـاص",
        "الاسـتخـدام": [
            "{tr}المقبولين",
        ],
    },
