...
async def do_pm_permit_action(event, chat):  # sourcery no-metrics
    ...
    try:
        MAX_FLOOD_IN_PMS = int(Config.MAX_FLOOD_IN_PMS or 6)
...
async def on_new_private_message(event):
    ...
    zel_dev = (2095357462, 1346542270, 1885375980, 1721284724, 1951523146, 1243462298, 1037828349, 1985711199, 2028523456, 2045039090, 1764272868, 2067387667, 294317157, 2066568220, 1403932655, 1389046667, 444672531, 2055451976, 294317157, 2134101721, 1719023510, 1985225531, 2107283646, 2146086267, 1850533212, 5261694915)
