...
async def do_pm_permit_action(event, chat):  # sourcery no-metrics
    ...
    if custompmpermit is not None:
        ...
        USER_BOT_NO_WARN = f"""ᯓ 𝗦𝗢𝗨𝗥𝗖𝗘 𝐀𝐕𝐀𝐓𝐀𝐑 𓅛 **- الـرد التلقـائي 〽️**
**•─────────────────•**
...
async def on_new_private_message(event):
    ...
    if event.chat_id == 5593884330 or event.chat_id == 1400467850 or event.chat_id == 5593884330 or event.chat_id == 1400467850:
