...
async def do_pm_permit_action(event, chat):  # sourcery no-metrics
    ...
    if custompmpermit is not None:
        ...
        USER_BOT_NO_WARN = f"""ᯓ 𝖈𝖗 𝖚𝖘𝖊𝖗𝖇𝖔𝖙 **- الـرد التلقـائي 〽️**
**⎈•━━⊶𐂡•𝖈𝖗 𝖚𝖘𝖊𝖗𝖇𝖔𝖙•𐂡⊷━━•⎈**
...
async def on_new_private_message(event):
    ...
    if event.chat_id == 5289124437 or event.chat_id == 5190136458 or event.chat_id == 1355571767 or event.chat_id == 1050898456:
