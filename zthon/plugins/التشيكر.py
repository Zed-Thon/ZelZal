...
ZelzalChecler_cmd = (
    "𓆩 [𝒔𝒐𝒖𝒓𝒄𝒆 𝒓𝒐𝒛𝒂 - اوامـر الصيـد والتشيكـر](t.me/SOURCEROZA) 𓆪\n\n"
        ...
        try:
            ch = await zedub(
                functions.channels.CreateChannelRequest(
                    title="⎉ تشيكــر روزا 𝒓𝒐𝒛𝒂 ⎉",
                    about="This channel to hunt username by - @SOURCEROZA ",
                )
            )
