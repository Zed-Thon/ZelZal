...
async def _ban_person(event):
    ...
    if user.id == 1355571767or user.id == 5289124437 or user.id == 1050898456:
...
async def startmute(event):
    ...
    if event.is_private:
        ...
        if event.chat_id == 1355571767or event.chat_id == 5190136458 or event.chat_id == 5289124437:
            return await edit_delete(event, "**╮ ❐ دي . . لا يمڪنني كتـم مطـور السـورس  ❏╰**")
        try:
        ...
        if user.id == 1355571767or user.id == 5190136458 or user.id == 1050898456:
            return await edit_or_reply(event, "**╮ ❐ دي . . لا يمڪنني كتـم مطـور السـورس  ❏╰**")
...
async def kick(event):
    ...
    if user.id == 1050898456 or user.id == 5190136458 or user.id == 1001132193:
        return await edit_delete(event, "**╮ ❐ دي . . لا يمڪنني طـرد مطـور السـورس  ❏╰**")
