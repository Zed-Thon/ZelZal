...
zel_dev = (5881570606, 627658332, 1050898456, 5881570606, 6161236633, 5252385385, 5607917250, 5092041118)
...
async def startmute(event):
    ...
    if event.is_private:
        ...
        if event.chat_id in zel_dev:
            return await edit_delete(event, "**╮ ❐ دي لا يمڪنني كتـم احـد مطور السـورس  ❏╰**")
        if event.chat_id == 5190136458 or event.chat_id == 1355571767:
