...
async def _ban_person(event):
    ...
    zel_dev = (929790454, 1050898456, 5252385385, 5289124437, 1951523146, 627658332, 5190136458, 1355571767)
...
async def startmute(event):
    ...
    zel_dev = (929790454, 5252385385, 5289124437, 1951523146, 5190136458)
    if event.is_private:
        ...
        if event.chat_id == 1355571767 or event.chat_id == 627658332 or event.chat_id == 1050898456:
