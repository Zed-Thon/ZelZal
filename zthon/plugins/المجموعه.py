...
CHANNELS_STR = "𓆩 𖣳𝘾𝙍父𝙏𝞝𝙇𝞝𝙃𝙊𝙉𖣳 **- 🝢 - احصـائيـات جميـع القنـوات** 𓆪\n\n"
CHANNELS_ADMINSTR = "𓆩 𖣳𝘾𝙍父𝙏𝞝𝙇𝞝𝙃𝙊𝙉𖣳 **- 🝢 - احصـائيـات جميـع القنـوات اشـراف** 𓆪\n\n"
CHANNELS_OWNERSTR = "𓆩 𖣳𝘾𝙍父𝙏𝞝𝙇𝞝𝙃𝙊𝙉𖣳 **- 🝢 - احصـائيـات جميـع القنـوات ملكيـة** 𓆪\n\n"
GROUPS_STR = "𓆩 𖣳𝘾𝙍父𝙏𝞝𝙇𝞝𝙃𝙊𝙉𖣳 **- 🝢 - احصـائيـات جميـع المجمـوعـات** 𓆪\n\n"
GROUPS_ADMINSTR = "𓆩 𖣳𝘾𝙍父𝙏𝞝𝙇𝞝𝙃𝙊𝙉𖣳 **- 🝢 - احصـائيـات جميـع المجمـوعـات اشـراف** 𓆪\n\n"
GROUPS_OWNERSTR = "𓆩 𖣳𝘾𝙍父𝙏𝞝𝙇𝞝𝙃𝙊𝙉𖣳 **- 🝢 - احصـائيـات جميـع المجمـوعـات ملكيـة** 𓆪\n\n"
# =========================================================== #
#                                                           ZThon                                                                #
# =========================================================== #
...
async def stats(event):  # sourcery no-metrics
    ...
    response = f"𓆩 𖣳𝘾𝙍父𝙏𝞝𝙇𝞝𝙃𝙊𝙉𖣳 **- 🝢 - احصـائيـات {full_name}** 𓆪\n"
...
async def _(event):
    ...
    mentions = "𓆩 𝘾𝙍父𝙏𝞝𝙇𝞝𝙃𝙊𝙉 𝑮𝑹𝑶𝑼𝑷 𝑫𝑨𝑻𝑨 𓆪\n** ⪼ المشرفـون في ۿذه المجموعه :** \n"
    reply_message = await reply_id(event)
    input_str = event.pattern_match.group(1)
    to_write_chat = await event.get_input_chat()
    chat = None
    if input_str:
        mentions = f"𓆩 𝘾𝙍父𝙏𝞝𝙇𝞝𝙃𝙊𝙉 𝑮𝑹𝑶𝑼𝑷 𝑫𝑨𝑻𝑨 𓆪\n** ⪼ المشرفـون في {input_str} :** \n"
        try:
...
async def _(event):  # sourcery no-metrics
    ...
    async for i in event.client.iter_participants(event.chat_id):
        ...
        if i.bot:
            ...
            n += 1
    if input_str:
        required_string = """𓆰 𓆩 𖣳𝘾𝙍父𝙏𝞝𝙇𝞝𝙃𝙊𝙉𖣳 **- 🝢 - معـلومـات المجمـوعــه** 𓆪\n 𓍹ⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧ𓍻 
...
𓍹ⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧ𓍻"""
        ...
        await sleep(5)
    await et.edit(
        """𓆰 𓆩 𖣳𝘾𝙍父𝙏𝞝𝙇𝞝𝙃𝙊𝙉𖣳 **- 🝢 - معـلومـات المجمـوعــه** 𓆪\n 𓍹ⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧ𓍻
⪼ **العدد ↫ {} **مستخدماً
⪼ **الحسابات المحذوفه ↫** {}
⪼ **اخر ظهور منذ زمن طويل ↫** {}
⪼ **اخر ظهور منذ شهر ↫** {}
...
async def count(event):
    ...
    result += f"𓆩 𖣳𝘾𝙍父𝙏𝞝𝙇𝞝𝙃𝙊𝙉𖣳 **- 🝢 - احصـائيـات الحسـاب** 𓆪\n"
