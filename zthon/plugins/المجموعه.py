...
@zedub.zed_cmd(
    ...
    info={
        ...
        "examples": "{tr}البوتات + معرف او رابط المجموعه",
    },
)
async def _(event):
    "To get list of bots."
...
async def get_chatinfo(event, catevent):
    ...
    try:
        ...
        try:
            ...
            LOGS.info(err)
            await edit_delete(catevent, "**❈╎لم يتم العثور على المجموعة او القناة**")
            return None
    return chat_info
...
async def zed(SLQ):
    ...
    try:
        ...
        return await bot.send_message(f"**❈╎عزيزي لسـت مشرفـاً في هـذه المجموعـه **")
