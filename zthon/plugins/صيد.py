...
ZelzalChecler_cmd = (
    "𓆩 [سۅٛࢪس ڪࢪستيڼ - اوامـر الصيـد والتشيكـر](t.me/pp_g3) 𓆪\n\n"
        ...
        try:
            ch = await zedub(
                functions.channels.CreateChannelRequest(
                    title="⎉ تشيكــر  ڪࢪستيڼ  ⎉",
                    about="This channel to hunt username by - @pp_g3 ",
                )
            )
