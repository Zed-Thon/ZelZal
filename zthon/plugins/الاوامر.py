...
async def zed_handler(event):
    ...
    if query.startswith("الاوامر") and event.query.user_id == zedub.uid:
        ...
        if ZEDPIC and ZEDPIC.endswith((".jpg", ".png")):
            result = builder.photo(ZEDPIC,text=Malath, buttons=buttons, link_preview=False)
        elif ZEDPIC and ZEDPIC.endswith((".gif", ".mp4")):
            result = builder.document(ZEDPIC,title="zedub", text=Malath ,buttons=buttons, link_preview=False)
        else:
...
@check_owner
async def on_plug_in_callback_query_handler(event):
    buttons = [[Button.inline("⓯", data="ahmad15"), Button.inline("⓰", data="ahmad16"), Button.inline("⓱", data="ahmad17"), Button.inline("⓲", data="ahmad18"),],[Button.inline("⇒", data="aahmed"),]]
