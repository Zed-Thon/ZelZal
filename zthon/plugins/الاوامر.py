...
async def on_plug_in_callback_query_handler(event):
    if event.is_private:
        text = "⤶ عـذراً عـزيـزي .. لوحـة الانلايـن لا تعمـل الا في المجمـوعـات 🤷🏻‍♀\n⤶ لـ عـرض الاوامـر قم باستخـدام الامـر\n\n (.الأوامر)"
