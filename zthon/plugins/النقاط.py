...
ZelzalCoins_cmd = (
    "[ᯓ 𝗦𝗼𝘂𝗿𝗰𝗲 𝖛𝖊𝖓𝖔𝖒 - اوامـر تجميـع النقـاط](t.me/q_k_2) 𓆪\n\n"
    ...
    "`.راتب وعد 50`\n\n\n"
    "**- مـلاحظــه :**\n"
    "**⪼ سيتم اضـافـه المزيـد من البوتـات بالتحديثـات الجايـه .. اذا تريـد اضافـة بـوت محـدد راسـل مطـور السـورس @iiqllll**"
)
