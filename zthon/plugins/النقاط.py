...
ZelzalCoins_cmd = (
    ...
    "`.المليار`\n"
    "**⪼ لـ تجميـع النقـاط مـن بـوت المليـار ( @Ss0Bot ) .. تلقـائيـاً ✓**\n\n"
    "`.الجوكر`\n"
...
async def _(event):
    await event.edit('@Ss0Bot')

# Copyright (C) 2022 Zed-Thon . All Rights Reserved
@zedub.zed_cmd(pattern="المليار ?(.*)")
async def _(event):
    con = event.pattern_match.group(1).lower()
    await event.edit("**⎉╎حسنـاً .. تأكـد من انك مشتـرك بـ قنـوات الاشتـراك الاجبـاري لتجنب الأخطـاء @Ss0Bot**")
    channel_entity = await zedub.get_entity('@Ss0Bot')
    await zedub.send_message('@Ss0Bot', '/start')
    await asyncio.sleep(4)
    msg0 = await zedub.get_messages('@Ss0Bot', limit=1)
    await msg0[0].click(2)
    await asyncio.sleep(4)
    msg1 = await zedub.get_messages('@Ss0Bot', limit=1)
    ...
    for i in range(100):
        ...
        try:
            ...
            msg2 = await zedub.get_messages('@Ss0Bot', limit=1)
