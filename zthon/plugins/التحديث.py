...
async def upstream(event):
    ...
    if conf == "" and not force_update:
        ...
        await event.delete()
        return await event.respond(f"𓆰 𝗦𝗢𝗨𝗥𝗖𝗘 𝙕𝞝𝘿 - 𝑼𝑷𝑫𝑨𝑻𝑬 𝑴𝑺𝑮 𓆪\n 𓍹ⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧ𓍻\n⪼ اضغط هنا **للتحديث السريع ↫ ** `{cmdhd}تحديث الان` او اضغط هنا **لتنصيب التحديث** وقد يستغرق 5 دقائق ↫ `{cmdhd}تحديث البوت`")
    if force_update:
        await event.edit(
            "`Force-Syncing to latest stable zthon code, please wait...`"
        )
    if conf == "الان":
