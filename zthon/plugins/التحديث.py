...
async def upstream(event):
    ...
    if conf == "الان":
        ...
        await event.edit("ᯓ 𝙏𝞝𝙇𝞝𝙃𝙊𝙉☥𝘾𝙍 - تحـديثـات السـورس\n**•─────────────────•**\n\n**⇜ يتـم تحـديث بـوت كرستين  .. انتظـر . . .🌐**\n\n%𝟷𝟶 ▬▭▭▭▭▭▭▭▭▭")
        await asyncio.sleep(1)
        await event.edit("ᯓ 𝙏𝞝𝙇𝞝𝙃𝙊𝙉☥𝘾𝙍 - تحـديثـات السـورس\n**•─────────────────•**\n\n**⇜ يتـم تحـديث بـوت كرستين  .. انتظـر . . .🌐**\n\n%𝟸𝟶 ▬▬▭▭▭▭▭▭▭▭")
        await asyncio.sleep(1)
        await event.edit("ᯓ 𝙏𝞝𝙇𝞝𝙃𝙊𝙉☥𝘾𝙍 - تحـديثـات السـورس\n**•─────────────────•**\n\n**⇜ يتـم تحـديث بـوت كرستين  .. انتظـر . . .🌐**\n\n%𝟹𝟶 ▬▬▬▭▭▭▭▭▭▭")
