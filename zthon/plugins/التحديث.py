...
async def upstream(event):
    ...
    if changelog == "" and not force_update:
        await event.edit(
            f"\nᯓ 𝗦𝗢𝗨𝗥𝗖𝗘 𝖛𝖊𝖓𝖔𝖒 - تحـديثـات السـورس\n**•─────────────────•**\n\n**⪼ سـورس زدثــون محـدث لـ آخـر إصـدار 🛂**"
        )
        return repo.__del__()
    if conf == "" and not force_update:
        return await edit_or_reply(event, f"ᯓ 𝗦𝗢𝗨𝗥𝗖𝗘 𝖛𝖊𝖓𝖔𝖒 - تحـديثـات السـورس\n**•─────────────────•**\n\n**•⎆┊يوجـد تحـديث جديـد لسـورس زدثــون ༗...**\n\n**•⎆┊للتحديث السريع اضغـط هنـا ⇜** ⦉ `{cmdhd}تحديث الان` ⦊ \n**•⎆┊للتحديث الجـذري اضغـط هنـا ⇜** ⦉ `{cmdhd}تحديث البوت` ⦊ \n\n𓆩 [𝖛𝖊𝖓𝖔𝖒](t.me/pp_g3) 𓆪")
    if force_update:
        await event.edit(
            "`Force-Syncing to latest stable userbot code, please wait...`"
        )
    if conf == "الان":
        await event.edit(f"ᯓ 𝗦𝗢𝗨𝗥𝗖𝗘 𝖛𝖊𝖓𝖔𝖒 - تحـديثـات السـورس\n**•─────────────────•**\n\n**⇜ يتـم تحـديث بـوت ڤي֠ــ‌ۢـ‌ٰـن֠ــ‌ۢـ‌ٰـﯛ‌م .. انتظـر . . .🌐**")
        await asyncio.sleep(1)
        await event.edit("ᯓ 𝗦𝗢𝗨𝗥𝗖𝗘 𝖛𝖊𝖓𝖔𝖒 - تحـديثـات السـورس\n**•─────────────────•**\n\n**⇜ يتـم تحـديث بـوت ڤي֠ــ‌ۢـ‌ٰـن֠ــ‌ۢـ‌ٰـﯛ‌م .. انتظـر . . .🌐**\n\n%𝟷𝟶 ▬▭▭▭▭▭▭▭▭▭")
        await asyncio.sleep(1)
        await event.edit("ᯓ 𝗦𝗢𝗨𝗥𝗖𝗘 𝖛𝖊𝖓𝖔𝖒 - تحـديثـات السـورس\n**•─────────────────•**\n\n**⇜ يتـم تحـديث بـوت ڤي֠ــ‌ۢـ‌ٰـن֠ــ‌ۢـ‌ٰـﯛ‌م .. انتظـر . . .🌐**\n\n%𝟸𝟶 ▬▬▭▭▭▭▭▭▭▭")
        await asyncio.sleep(1)
        await event.edit("ᯓ 𝗦𝗢𝗨𝗥𝗖𝗘 𝖛𝖊𝖓𝖔𝖒 - تحـديثـات السـورس\n**•─────────────────•**\n\n**⇜ يتـم تحـديث بـوت ڤي֠ــ‌ۢـ‌ٰـن֠ــ‌ۢـ‌ٰـﯛ‌م .. انتظـر . . .🌐**\n\n%𝟹𝟶 ▬▬▬▭▭▭▭▭▭▭")
