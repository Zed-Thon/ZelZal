...
ZelzalWF_cmd = (
    "𓆩 [𖢾𝒔𝒐𝒖𝒓𝒄𝒆 𝒓𝒐𝒛𝒂𖢾 - اوامـر الـردود / والتـرحيب](t.me/SOURCEROZA) 𓆪\n\n"
    ...
    "\n 𓆩 [𖢾𝒔𝒐𝒖𝒓𝒄𝒆 𝒓𝒐𝒛𝒂𖢾](t.me/SOURCEROZA) 𓆪"
)
...
async def on_all_snip_delete(event):
    ...
    if filters:
        ...
        await edit_or_reply(event, "𓆩 𖢾𝒔𝒐𝒖𝒓𝒄𝒆 𝒓𝒐𝒛𝒂𖢾 𝑭𝑰𝑳𝑻𝑬𝑹𝑺 𓆪\n 𓍹ⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧ𓍻\n**⪼ تم حذف جـميع الــردود المضـافـهہ بنجـاح☑️**")
    else:
