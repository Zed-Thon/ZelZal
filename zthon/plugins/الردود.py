...
ZelzalWF_cmd = (
    "𓆩 [𝗦𝗼𝘂𝗿𝗰𝗲 ᴧꝛᴛᴇx 𝗖𝗼𝗻𝗳𝗶𝗴 - اوامـر الـردود / والتـرحيب](t.me/pp_g3) 𓆪\n\n"
...
async def on_all_snip_delete(event):
    ...
    if filters:
        ...
        await edit_or_reply(event, "𓆩 𝑺𝑶𝑼𝑹𝑪𝑬 ᴧꝛᴛᴇx 𝑭𝑰𝑳𝑻𝑬𝑹𝑺 𓆪\n 𓍹ⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧ𓍻\n**⪼ تم حذف جـميع الــردود المضـافـهہ بنجـاح☑️**")
    else:
