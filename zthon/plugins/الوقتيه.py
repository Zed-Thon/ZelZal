...
ZelzalVP_cmd = (
    ...
    "⪼ `.الوقتيه 8` / `.الوقتي 8`\n\n"
    "⪼ `.الوقتيه 9` / `.الوقتي 9`\n\n"
    "⪼ `.الوقتيه 10` / `.الوقتي 10`\n\n"
    "⪼ `.الوقتيه 11` / `.الوقتي 11`\n\n"
    "⪼ `.الوقتيه 12` / `.الوقتي 12`\n\n"
    "⪼ `.الوقتيه 13` / `.الوقتي 13`\n\n"
    "⪼ `.الوقتيه 14` / `.الوقتي 14`\n\n"
    "⪼ `.الوقتيه 15`\n\n"
    "⪼ `.الوقتيه 16`\n\n"
    "⪼ `.الوقتيه 17`\n\n\n"
...
# Copyright (C) 2022 @Zed-Thon . All Rights Reserved
@zedub.zed_cmd(pattern="الوقتيه(?:\s|$)([\s\S]*)")
