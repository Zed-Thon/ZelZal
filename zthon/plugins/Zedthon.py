    ...
    if query_user_id == Config.OWNER_ID or query_user_id in Config.SUDO_USERS:
        ...
        if match or match2 or match3:
            ...
            result = builder.article(
                title=f"{info_type[0].title()} سـࢪيـه الـى {sandy}.",
                ...
                text="✖✖✖"
                if match3
                else f"ᯓ 𝗦𝗢𝗨𝗥𝗖𝗘 𝗭𝗧𝗛𝗢𝗡 **- همسـة سـࢪيـه 📠**\n⋆┄─┄─┄─┄┄─┄─┄─┄─┄┄⋆\n\n**⌔╎الهمسـة لـ** {sandy} \n**⌔╎هو فقط من يستطيع ࢪؤيتهـا**",
                buttons=buttons,
            )
            ...
            results.append(
                builder.article(
                    ...
                    text=f"ᯓ 𝗦𝗢𝗨𝗥𝗖𝗘 𝗭𝗧𝗛𝗢𝗡 **- همسـة سـࢪيـه\n⋆┄─┄─┄─┄┄─┄─┄─┄─┄┄⋆**\n\n⌔╎**اضغـط الـزࢪ 🚹 بالاسفـل**\n⌔╎**لـ اࢪسـال همسـه سـࢪيـه الى** [الشخص](tg://user?id={uzerid}) 💌\n⌔╎**او اضغـط الـزࢪ 🛗 بالاسفـل**\n⌔╎**لـ اࢪسـال همسـه جماعية الى هذا الشخص وأشخـاص آخرون 💌**",
