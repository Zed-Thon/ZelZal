...
ZelzalVP_cmd = (
    "𓆩 [ŜỖǗŘČẸ ČŘ 𝗖𝗼𝗻𝗳𝗶𝗴 𝗩𝗮𝗿𝘀 - اوامـر الفـارات](t.me/q_k_2) 𓆪\n\n"
    ...
    "\n𓆩 [ČŘ  𝙑𝙖𝙧𝙨 - قنـاة الفـارات](t.me/q_k_2) 𓆪"
)
...
async def variable(event):
    ...
    if input_str == "كليشة الفحص" or input_str == "كليشه الفحص":
        ...
        if variable in heroku_var:
            await zed.edit("**⎉╎تم تغييـر {} بنجـاح ☑️**\n**⎉╎المتغيـر : ↶**\n `{}` \n**⎉╎يتم الان اعـادة تشغيـل بـوت 𖤐𝖛𝖊𝖓𝖔𝖒𖤐  يستغـرق الامر 2-1 دقيقـه ▬▭ ...**".format(input_str, vinfo))
        else:
...
async def variable(event):
    ...
    if input_str == "كليشة الفحص" or input_str == "كليشه الفحص":
        ...
        await zed.edit("**⎉╎تم حـذف {} بنجـاح ☑️**\n**⎉╎المتغيـر المحـذوف : ↶**\n `{}` \n**⎉╎يتم الان اعـادة تشغيـل بـوت 𖤐𝖛𝖊𝖓𝖔𝖒𖤐  يستغـرق الامر 2-1 دقيقـه ▬▭ ...**".format(input_str, heroku_var[variable]))
...
async def custom_zed(event):
    ...
    if (input_str == "كليشة الحماية" or input_str == "كليشة الحمايه" or input_str == "كليشه الحماية" or input_str == "كليشه الحمايه"):
        ...
        if variable is None:
            ...
            await zed.edit("**⎉╎الفـار {} موجـود ☑️**\n**⎉╎قيمـة الفـار : ↶**\n `{}` \n\n**⎉╎قنـاة السـورس : @q_k_2**".format(input_str, variable))
...
async def variable(event):
    ...
    if input_str == "العراق" or input_str == "عراق":
        ...
        await asyncio.sleep(1.5)
        if variable in heroku_var:
            await zed.edit("**⎉╎تم تغييـر المنطقـه الزمنيـه .. بنجـاح ☑️**\n**⎉╎المتغير : ↶**\n دولـة `{}` 🇮🇶 \n**⎉╎يتم الان اعـادة تشغيـل بـوت 𖤐𝖛𝖊𝖓𝖔𝖒𖤐  يستغـرق الامر 2-1 دقيقـه ▬▭ ...**".format(input_str))
        else:
    ...
    if malatha.reply_to_msg_id:
        ...
        if input_str in ["الحماية", "الحمايه"]:
            ...
            try:
                ...
                await zed.edit("**⎉╎تم تغييـر صـورة {} .. بنجـاح ☑️**\n**⎉╎المتغيـر : ↶**\n `{}` \n\n**⎉╎قنـاة السـورس : @q_k_2**".format(input_str, vinfo))
