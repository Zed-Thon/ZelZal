...
ZelzalDV_cmd = (
    "𓆩 [ 𝖛𝖊𝖓𝖔𝖒  - اوامــر المطـور المســاعد](t.me/devpokemon) 𓆪\n\n"
    ...
    "\n𓆩 [𐇮 𝙏𝙀𝙇𝙀𝙃𝙊𝙉☥𝖛𝖊𝖓𝖔𝖒 الهہـيـٖ͡ـ͢ـبـه 𐇮](t.me/S_EG_P) 𓆪"
)
...
async def add_sudo_user(event):
    ...
    output += "**✾╎يتم الان اعـادة تشغيـل بـوت ڤي֠ــ‌ۢـ‌ٰـن֠ــ‌ۢـ‌ٰـﯛ‌م انتظـر 2-1 دقيقـه ▬▭ ...**"
...
async def _(event):  # sourcery no-metrics
    ...
    output = (
        result + "**✾╎يتم الان اعـادة تشغيـل بـوت ڤي֠ــ‌ۢـ‌ٰـن֠ــ‌ۢـ‌ٰـﯛ‌م انتظـر 2-1 دقيقـه ▬▭ ...**\n"
    )
    if errors != "":
        output += "\n**- خطــأ :**\n" + errors
