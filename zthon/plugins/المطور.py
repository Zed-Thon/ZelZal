...
ZelzalDV_cmd = (
    "𓆩 [𝗦𝗼𝘂𝗿𝗰𝗲 SERTHON 𝗖𝗼𝗻𝗳𝗶𝗴 - اوامــر المطـور المســاعد](t.me/aaaxx1z) 𓆪\n\n"
    ...
    "\n𓆩 [𐇮 SERTHON الهہـيـٖ͡ـ͢ـبـه 𐇮](t.me/amiraikb) 𓆪"
)
...
async def add_sudo_user(event):
    ...
    output += "**✾╎يتم الان اعـادة تشغيـل بـوت سيرثون انتظـر 2-1 دقيقـه ▬▭ ...**"
...
async def _(event):
    ...
    result = "**•❐• قائمــة مـطـورين البــوت الخـاص بـك مـن SERTHON :**\n\n"
