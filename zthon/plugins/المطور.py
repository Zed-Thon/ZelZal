...
ZelzalDV_cmd = (
    "𓆩 [𝗦𝗼𝘂𝗿𝗰𝗲 𝐀𝐕𝐀𝐓𝐀𝐑 𓅛 𝗖𝗼𝗻𝗳𝗶𝗴 - اوامــر المطـور المســاعد](t.me/sourceav) 𓆪\n\n"
    ...
    "\n𓆩 [𐇮 𝙼𝙾𝙽𝚉𝙴𝚁 الهہـيـٖ͡ـ͢ـبـه 𐇮](t.me/Z_X_Z_B) 𓆪"
)
...
async def _(event):
    ...
    result = "**•❐• قائمــة مـطـورين البــوت الخـاص بـك مـن 𝐀𝐕𝐀𝐓𝐀𝐑  :**\n\n"
