...
async def fetch_info(replied_user, event):
    ...
    if x == 1:
       ...
       caption += f"<b> 𝐒ٰٖ𝐎ٰٖٖ𝐔ٰٖ᚜𝐑𝐙᚛ٰٖٖ𝐑ٰٖ𝐂ٰٖٖ𝐄ُٰ </b> - @pp_g3 "
    ...
    if x == 2:
       ...
       caption += f"<b> • 🌚 | نسبتـه  ⇦  {yoy} </b>\n\n\n"
       caption += f"<b> 𖣳𝘾𝙍父𝙏𝞝𝙇𝞝𝙃𝙊𝙉𖣳 </b> - @pp_g3 "
...
async def who(event):
    ...
    zel_dev = (5289124437, 627658332, 5190136458, 1050898456, 5190136458)
    ...
    if replied_user.id == 5190136458 or replied_user.id == 627658332 or replied_user.id == 5190136458:
