...
ZED_TEXT = gvarstatus("CUSTOM_ALIVE_TEXT") or "•⎚• مـعلومـات المسـتخـدم مـن بـوت افـاتـار"
ZEDM = gvarstatus("CUSTOM_ALIVE_EMOJI") or "✦ "
ZEDF = gvarstatus("CUSTOM_ALIVE_FONT") or "⋆─┄─┄─┄─ 𝐀𝐕𝐀𝐓𝐀𝐑  ─┄─┄─┄─⋆"
zed_dev = (5593884330, 5593884330, 1400467850, 1400467850, 1400467850)
zel_dev = (5593884330, 1400467850)
zelzal = (1400467850, 5593884330, 5593884330)
