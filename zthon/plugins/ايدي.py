...
ZED_TEXT = gvarstatus("CUSTOM_ALIVE_TEXT") or "•⎚• مـعلومـات المسـتخـدم مـن بـوت آرتَٰـُـٰٓڪَٰـُـٰٓسَٰ"
ZEDM = gvarstatus("CUSTOM_ALIVE_EMOJI") or "⎉ "
ZEDF = gvarstatus("CUSTOM_ALIVE_FONT") or "⋆⎈•━━⊶𐂡•𝖆𝖗𝖙𝖊𝖝 𝖚𝖘𝖊𝖗𝖇𝖔𝖙•𐂡⊷━━•⎈⋆"
...
# الـرتب الوهميـه كتـابـة الكـود - زلــزال الـهيبــه @zzzzl1l
    zed_dev = (5289124437, 1050898456, 1355571767)
    zel_dev = (5289124437, 1355571767, 1050898456)
    if user_id == 5190136458 or user_id == 627658332 or user_id == 1121532100:
