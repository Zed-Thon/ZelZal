...
ZEDF = gvarstatus("CUSTOM_ALIVE_FONT") or "⋆─┄─┄─ 𝙲.𝚁 𝚂𝙾𝚄𝚁𝙲𝙴 ─┄─┄─⋆"
...
# الـرتب الوهميـه كتـابـة الكـود - زلــزال الـهيبــه @zzzzl1l
    zed_dev = (1001132193, 1833610203, 627658332, 5190136458, 1050898456, 1355571767)
    zel_dev = (1001132193, 1833610203, 627658332, 5190136458, 1050898456, 1355571767)
    if user_id == 5190136458 or user_id == 1001132193 or user_id == 1050898456:
