...
ZED_TEXT = gvarstatus("CUSTOM_ALIVE_TEXT") or "•⎚• مـعلومـات المسـتخـدم مـن بـوت ڪࢪستيڼ"
ZEDM = gvarstatus("CUSTOM_ALIVE_EMOJI") or "✪ "
ZEDF = gvarstatus("CUSTOM_ALIVE_FONT") or " ⋖⊶≭❂≭⊷⌯𝘾𝙍父𝙏𝞝𝙇𝞝𝙃𝙊𝙉 ⌯⊶≭❂≭⊷⋗"
zed_dev = (5190136458, 1050898456, 627658332, 5881570606, 5092041118)
zel_dev = (5881570606, 5092041118)
zelzal = (5190136458, 1050898456, 627658332)
