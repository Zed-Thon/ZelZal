...
ZED_TEXT = gvarstatus("CUSTOM_ALIVE_TEXT") or "•⎚• مـعلومـات المسـتخـدم مـن بـوت افتار"
ZEDM = gvarstatus("CUSTOM_ALIVE_EMOJI") or "𖣐 "
ZEDF = gvarstatus("CUSTOM_ALIVE_FONT") or "⋆⎈•━━⊶𖢵•𝘀𝗼𝘂𝗿𝗰𝗲 𝗮𝘃𝗮𝘁𝗮𝗿•𖢵⊷━━•⎈⋆"
...
# الـرتب الوهميـه كتـابـة الكـود - زلــزال الـهيبــه @zzzzl1l
    ...
    if user_id == 5190136458 or user_id == 627658332 or user_id == 1400467850:
