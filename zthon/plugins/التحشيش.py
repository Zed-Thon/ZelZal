...
zel_dev = (929790454, 1050898456, 5252385385, 5289124437, 1951523146, 6251351549, 5881570606)
...
async def _(zed):
    await edit_or_reply (zed, "𓆰 [ᥴℛ ۩ - 𝘿𝙀𝙇𝙀𝙏𝙀](t.me/pp_g3) 🗑♻️𓆪\n**𓍹━─━─━─ᥴℛ ۩─━─━─━𓍻**\n\n **✵│رابـط الحـذف ↬** https://telegram.org/deactivate \n\n\n **✵│بـوت الحـذف  ↬** @LC6BOT ")
...
ZelzalTHS_cmd = (
    "𓆩 [ᥴℛ ۩ • 𝗖𝗼𝗻𝗳𝗶𝗴 𝗩𝗮𝗿𝘀 - اوامـر التحشيش](t.me/pp_g3) 𓆪\n\n"
    "⋖⊶≭❂≭⊷⌯𝘾𝙍父𝙏𝞝𝙇𝞝𝙃𝙊𝙉 ⌯⊶≭❂≭⊷⋗\n\n"
