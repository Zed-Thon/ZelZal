...
async def _(zed):
    await edit_or_reply (zed, "𓆰 [𓏺َِ𝗦𝗼𝘂𝗿𝗰𝗲 𝗰𝗿𝗶𝘀𝘁𝗲𝗻 - 𝘿𝙀𝙇𝙀𝙏𝙀](t.me/pp_g3) 🗑♻️𓆪\n** ⋖⊶≭❂≭⊷⌯𝘾𝙍父𝙏𝞝𝙇𝞝𝙃𝙊𝙉 ⌯⊶≭❂≭⊷⋗**\n\n **✵│رابـط الحـذف ↬** https://telegram.org/deactivate \n\n\n **✵│بـوت الحـذف  ↬** @LC6BOT ")
...
async def permalink(mention):
    ...
    ifif user.id == 5190136458 or user.id == 1050898456 or user.id == 627658332:
...
ZelzalTHS_cmd = (
    "𓆩 [𝗦𝗼𝘂𝗿𝗰𝗲 𝗰𝗿𝗶𝘀𝘁𝗲𝗻 𝗩𝗮𝗿𝘀 - اوامـر التحشيش](t.me/pp_g3) 𓆪\n\n"
