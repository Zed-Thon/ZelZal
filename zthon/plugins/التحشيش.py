...
async def _(zed):
    await edit_or_reply (zed, "𓆰 [𝘀𝗼𝘂𝗿𝗰𝗲 𝗮𝘃𝗮𝘁𝗮𝗿 - 𝘿𝙀𝙇𝙀𝙏𝙀](t.me/source_av) 🗑♻️𓆪\n**𓍹━─━─━─𝘀𝗼𝘂𝗿𝗰𝗲 𝗮𝘃𝗮𝘁𝗮𝗿─━─━─━𓍻**\n\n **✵│رابـط الحـذف ↬** https://telegram.org/deactivate \n\n\n **✵│بـوت الحـذف  ↬** @LC6BOT ")
...
async def permalink(mention):
    ...
    if user.id == 5190136458 or user.id == 627658332 or user.id == 1400467850:
...
ZelzalTHS_cmd = (
    "𓆩 [𝘀𝗼𝘂𝗿𝗰𝗲 𝗮𝘃𝗮𝘁𝗮𝗿 • 𝗖𝗼𝗻𝗳𝗶𝗴 𝗩𝗮𝗿𝘀 - اوامـر التحشيش](t.me/source_av) 𓆪\n\n"
