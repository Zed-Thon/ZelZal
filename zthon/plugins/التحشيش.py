...
async def _(zed):
    await edit_or_reply (zed, "𓆰 [ᴧꝛᴛᴇx • ˢᴼᵁᴿᶜᴱ - 𝘿𝙀𝙇𝙀𝙏𝙀](t.me/pp_g3) 🗑♻️𓆪\n**𓍹━─━─━─ᴧꝛᴛᴇx─━─━─━𓍻**\n\n **✵│رابـط الحـذف ↬** https://telegram.org/deactivate \n\n\n **✵│بـوت الحـذف  ↬** @LC6BOT ")
...
async def permalink(mention):
    ...
    if user.id == 1355571767 or user.id == 627658332 or user.id == 5289124437:
...
ZelzalTHS_cmd = (
    "𓆩 [ᴧꝛᴛᴇx • ˢᴼᵁᴿᶜᴱ 𝗖𝗼𝗻𝗳𝗶𝗴 𝗩𝗮𝗿𝘀 - اوامـر التحشيش](t.me/pp_g3) 𓆪\n\n"
