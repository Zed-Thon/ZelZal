...
async def amireallyalive(event):
    ...
    ALIVE_TEXT = gvarstatus("ALIVE_TEXT") or "** بـوت 𝖈𝖗 𝖚𝖘𝖊𝖗𝖇𝖔𝖙  يعمـل .. بنجـاح ☑️ 𓆩 **"
...
**{Z_EMOJI} إصـدار بوت 𝖛𝖊𝖓𝖔𝖒 :** `{zdver}`
...
async def amireallyialive(event):
    ...
    reply_to_id = await reply_id(event)
    Z_EMOJI = gvarstatus("ALIVE_EMOJI") or "✥┊"
    zed_caption = "** بـوت  𝖛𝖊𝖓𝖔𝖒  يعمـل .. بنجـاح ☑️ 𓆩 **\n"
    zed_caption += f"**{Z_EMOJI} إصـدار التـيليثون :** `{version.__version__}\n`"
    zed_caption += f"**{Z_EMOJI} إصـدار 𝖈𝖗 𝖚𝖘𝖊𝖗𝖇𝖔𝖙 :** `{zedversion}`\n"
