...
@zedub.zed_cmd(
    pattern=f"{ZADD} ?(.*)",
    command=("ضيف", plugin_category),
    info={
        "header": "لـ اضافـة وسحـب اعضـاء مـن كـروب لـ كـروب آخر",
        "الاستـخـدام": " {tr}ضيف + رابـط او معرف الكـروب التريد تسحب منه اعضاء .. تستخدم الامـر بالكروب اللي تريد تضيفله اعضاء",
    },
)
