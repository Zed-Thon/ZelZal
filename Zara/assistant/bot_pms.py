    ...
    if chat.id != Config.OWNER_ID:
        ...
        if customstrmsg is not None:
            ...
            start_msg = f"**❈╎مـرحباً بـك عزيـزي  {mention} **\
                        ...
                        \n\n**❈╎البـوت خـاص بسـورس :** [𝗭𝗧𝗵𝗼𝗻𓅛](https://t.me/ZThon)"
        buttons = [
            (
        ...
        start_msg = "**❈╎مـرحبـاً بـك مـطـوري 🙈🖤..**\n**❈╎انا البـوت المسـاعـد زد الخـاص بـك 😼🦾**\n**❈╎يستطيـع اي شخص التواصل بك من خلالي**\n**❈╎لا تستغرب انني ايضاً بمثابة بوت تواصـل خاص بك✌️**\n\n**❈╎لرؤيـة اوامـري الخاصـه بـك اضغـط :  /help **"
        buttons = None
    try:
        if custompic:
