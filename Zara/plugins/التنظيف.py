...
@zedub.zed_cmd(
    pattern="حذف_من",
    command=("حذف_من", plugin_category),
    info={
        "header": "To mark the replied message as starting message of purge list.",
        "الوصـف": "After using this u must use purgeto command also so that the messages in between this will delete.",
        "الاستخـدام": "{tr}purgefrom",
    },
)
...
@zedub.zed_cmd(
    pattern="حذف_الى",
    command=("حذف_الى", plugin_category),
    info={
        "header": "To mark the replied message as end message of purge list.",
        "الوصـف": "U need to use purgefrom command before using this command to function this.",
        "الاستخـدام": "{tr}purgeto",
    },
)
...
@zedub.zed_cmd(
    ...
    info={
        ...
        "الوصـف": "Deletes x(count) amount of your latest messages.",
        "الاستخـدام": "{tr}purgeme <count>",
        "مثــال": "{tr}purgeme 2",
    },
)
