...
autopic_path = os.path.join(os.getcwd(), "Zara", "original_pic.png")
digitalpic_path = os.path.join(os.getcwd(), "Zara", "digital_pic.png")
autophoto_path = os.path.join(os.getcwd(), "Zara", "photo_pfp.png")
    ...
    while DIGITALPICSTART:
        if not os.path.exists(digitalpic_path):
            ...
            while not downloader.isFinished():
                pass
        zedfont = gvarstatus("DEFAULT_PIC") or "Zara/helpers/styles/Papernotes.ttf"
