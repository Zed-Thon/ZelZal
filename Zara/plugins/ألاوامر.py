...
async def zed_handler(event):
    ...
    if query.startswith("ألاوامر") and event.query.user_id == zedub.uid:
        buttons = [[Button.inline("❶", data="ahmed1"), Button.inline("❷", data="ahmed2"), Button.inline("❸", data="ahmed3"), Button.inline("❹", data="ahmed4"),],[Button.inline("❺", data="ahmed5"), Button.inline("❻", data="ahmed6"), Button.inline("❼", data="ahmed7"), Button.inline("⇒", data="back1"),],[Button.inline("❽", data="ahmed8"), Button.inline("❾", data="ahmed9"), Button.inline("❿", data="ahmad10"), Button.inline("⓫", data="ahmad11"),],[Button.inline("⓬", data="ahmad12"), Button.inline("⓭", data="ahmad13"), Button.inline("⓮", data="ahmad14"), Button.inline("⇒", data="back2"),],[Button.inline("⓯", data="ahmad15"), Button.inline("⓰", data="ahmad16"), Button.inline("⓱", data="ahmad17"),],[Button.inline("⓲", data="ahmad18"), Button.inline("⓳", data="ahmad19"), Button.inline("⇒", data="backend"),]]
...
@zedub.tgbot.on(CallbackQuery(data=re.compile(rb"backend")))
@check_owner
async def zed_handler(event):
    zelzal = "⤶ عـذراً عـزيـزي 🤷🏻‍♀\n⤶ لقـد تم دمـج اللوحات في لوحـه واحـده\n⤶ لا يوجـد لوحـه تاليه حاليـاً"
