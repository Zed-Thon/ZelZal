...
ZPOINT = gvarstatus("Z_Point") or "@zmmbot"
...
async def _(event):
    ...
    await zedub.send_message(point_bot1, '/start')
    await asyncio.sleep(4)
    msg0 = await zedub.get_messages(point_bot1, limit=1)
    await msg0[0].click(2)
    await asyncio.sleep(4)
    msg1 = await zedub.get_messages(point_bot1, limit=1)
    ...
    for i in range(100):
        ...
        try:
            ...
            msg2 = await zedub.get_messages(point_bot1, limit=1)
