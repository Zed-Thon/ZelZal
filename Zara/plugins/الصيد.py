...
async def hunterusername(event):
        ...
        if isav == True:
            try:
                ...
                if "(caused by UpdateUsernameRequest)" in str(baned):
                    pass
            except telethon.errors.FloodWaitError as zed: #code by t.me/zzzzl1l
                await sleep(zed.seconds + 5)
                pass
            except TypeError: #code by t.me/zzzzl1l
                pass
    ...
    isclaim.clear()
    isclaim.append("off")
    await event.client.send_message(event.chat_id, "**- تم الانتهاء من الصيد .. بنجـاح ✅**")
...
async def _(event):
    ...
    isclaim.clear()
    isclaim.append("off")
    await jmub.send_message(event.chat_id, "**- تم الانتهاء من التثبيت .. بنجـاح ✅**")
