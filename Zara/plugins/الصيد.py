...
async def hunterusername(event):
    ...
    while zedmod:
        ...
        if username == "error":
            await event.edit("**- عـذراً عـزيـزي\n- لايوجـد نوع** {choice} \n**- لـ عرض الانواع ارسـل (**`.النوع`**)**")
            break
        ...
        if isav == True:
            try:
                ...
                zedmod = False
                break
            except telethon.errors.rpcerrorlist.UsernameOccupiedError: #code by t.me/zzzzl1l
                pass
                ...
                if "username is already" in str(eee):
                    pass
