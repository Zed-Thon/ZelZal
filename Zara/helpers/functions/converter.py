...
from Zara.helpers.functions.vidtools import take_screen_shot
from Zara.helpers.tools import fileinfo, media_type, meme_type
from Zara.helpers.utils.utils import runcmd
